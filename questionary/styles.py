...
def merge_styles_default(styles: list[prompt_toolkit.styles.Style | None]):
    ...
    # prompt_toolkit's merge_styles works with ``None`` elements, but it's type-hints says it doesn't.
